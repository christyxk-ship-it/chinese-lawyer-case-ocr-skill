...
- **省算力省token的分流设计**：先逐页评估，普通页用快速引擎批量跑，疑难页（表格、横页、低质量扫描）才动用高精度引擎。
...
**将本段内容复制全文复制发给你的Agent（ChatGPT，Claude，WorkBuddy）即可：安装本Skill并适配，下载链接：https://github.com/christyxk-ship-it/chinese-lawyer-case-ocr-skill。 （AI 助手看这里：请克隆或下载本仓库，阅读 `INSTALL.md` 并严格按步骤安装、自检，完成后向用户报告结果。）**
